...
CB.v_open	equ	$015E	; OPEN command
CB.v_valid	equ	$0161	; device number validity check
...
CB.v_onerrgoto	equ	$018E	; RSVP for ON ERROR GOTO
CB.v_error	equ	$0191	; error driver
CB.v_run	equ	$0194	; RUN
CB.v_strtof	equ	$0197	; ASCII to FP
CB.v_interploop	equ	$019A	; BASIC command interpreter loop
CB.v_point	equ	$019D	; RESET/SET/POINT
CB.v_cls	equ	$01A0	; CLS
CB.v_crunch	equ	$01A3	; crunch BASIC line
CB.v_uncrunch	equ	$01A6	; uncrunch BASIC line
